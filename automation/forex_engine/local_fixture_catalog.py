...
FIXTURE_SPECS: dict[str, dict[str, Any]] = {
    ...
    "EURUSD_15M_CHOP_SAMPLE": {
        ...
        "regime": "chop",
        "rows": [
            ("2026-06-15T17:00:00Z", 1.1120, 1.1131, 1.1110, 1.1127, 1180),
            ("2026-06-15T17:15:00Z", 1.1127, 1.1130, 1.1111, 1.1117, 1190),
            ("2026-06-15T17:30:00Z", 1.1117, 1.1129, 1.1110, 1.1125, 1200),
            ("2026-06-15T17:45:00Z", 1.1125, 1.1128, 1.1108, 1.1116, 1210),
            ("2026-06-15T18:00:00Z", 1.1116, 1.1127, 1.1110, 1.1124, 1220),
            ("2026-06-15T18:15:00Z", 1.1124, 1.1129, 1.1109, 1.1115, 1230),
            ("2026-06-15T18:30:00Z", 1.1115, 1.1128, 1.1111, 1.1126, 1240),
            ("2026-06-15T18:45:00Z", 1.1126, 1.1130, 1.1112, 1.1118, 1250),
        ],
    },
    "GBPUSD_5M_CHOP_SAMPLE": {
        "symbol": "GBPUSD",
        ...
        "regime": "chop",
        "rows": [
            ("2026-06-15T10:00:00Z", 1.2810, 1.2820, 1.2802, 1.2817, 1320),
            ("2026-06-15T10:05:00Z", 1.2817, 1.2821, 1.2801, 1.2808, 1330),
            ("2026-06-15T10:10:00Z", 1.2808, 1.2819, 1.2800, 1.2815, 1340),
            ("2026-06-15T10:15:00Z", 1.2815, 1.2818, 1.2799, 1.2806, 1350),
            ("2026-06-15T10:20:00Z", 1.2806, 1.2818, 1.2801, 1.2814, 1360),
            ("2026-06-15T10:25:00Z", 1.2814, 1.2819, 1.2800, 1.2807, 1370),
            ("2026-06-15T10:30:00Z", 1.2807, 1.2820, 1.2802, 1.2816, 1380),
            ("2026-06-15T10:35:00Z", 1.2816, 1.2821, 1.2803, 1.2809, 1390),
        ],
    },
    "USDJPY_5M_TREND_SAMPLE": {
        "symbol": "USDJPY",
        ...
        "regime": "trend",
        "rows": [
            ("2026-06-15T11:00:00Z", 155.40, 155.58, 155.34, 155.52, 1700),
            ("2026-06-15T11:05:00Z", 155.52, 155.72, 155.48, 155.66, 1710),
            ("2026-06-15T11:10:00Z", 155.66, 155.85, 155.61, 155.78, 1720),
            ("2026-06-15T11:15:00Z", 155.78, 155.98, 155.73, 155.91, 1730),
            ("2026-06-15T11:20:00Z", 155.91, 156.10, 155.86, 156.04, 1740),
            ("2026-06-15T11:25:00Z", 156.04, 156.24, 155.99, 156.18, 1750),
            ("2026-06-15T11:30:00Z", 156.18, 156.38, 156.12, 156.31, 1760),
            ("2026-06-15T11:35:00Z", 156.31, 156.50, 156.25, 156.43, 1770),
        ],
    },
    "USDJPY_15M_RANGE_SAMPLE": {
        "symbol": "USDJPY",
        ...
        "regime": "range",
        "rows": [
            ("2026-06-15T12:00:00Z", 156.10, 156.28, 155.94, 156.23, 1660),
            ("2026-06-15T12:15:00Z", 156.23, 156.31, 155.95, 156.05, 1670),
            ("2026-06-15T12:30:00Z", 156.05, 156.26, 155.92, 156.20, 1680),
            ("2026-06-15T12:45:00Z", 156.20, 156.30, 155.91, 156.02, 1690),
            ("2026-06-15T13:00:00Z", 156.02, 156.24, 155.90, 156.18, 1700),
            ("2026-06-15T13:15:00Z", 156.18, 156.29, 155.93, 156.04, 1710),
            ("2026-06-15T13:30:00Z", 156.04, 156.27, 155.94, 156.21, 1720),
            ("2026-06-15T13:45:00Z", 156.21, 156.32, 155.96, 156.06, 1730),
        ],
    },
    "GBPUSD_15M_PULLBACK_SAMPLE": {
        "symbol": "GBPUSD",
        ...
        "regime": "pullback",
        "rows": [
            ("2026-06-15T14:00:00Z", 1.2760, 1.2778, 1.2755, 1.2772, 1500),
            ("2026-06-15T14:15:00Z", 1.2772, 1.2790, 1.2769, 1.2785, 1510),
            ("2026-06-15T14:30:00Z", 1.2785, 1.2791, 1.2773, 1.2778, 1520),
            ("2026-06-15T14:45:00Z", 1.2778, 1.2801, 1.2775, 1.2796, 1530),
            ("2026-06-15T15:00:00Z", 1.2796, 1.2803, 1.2782, 1.2789, 1540),
            ("2026-06-15T15:15:00Z", 1.2789, 1.2810, 1.2785, 1.2804, 1550),
            ("2026-06-15T15:30:00Z", 1.2804, 1.2820, 1.2800, 1.2814, 1560),
            ("2026-06-15T15:45:00Z", 1.2814, 1.2831, 1.2810, 1.2824, 1570),
        ],
    },
}
