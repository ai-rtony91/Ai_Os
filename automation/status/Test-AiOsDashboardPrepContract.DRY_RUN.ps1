...
Write-Host 'Task name: AI_OS Stage 36A-36D Dashboard Prep Contract Dry Run'
...
if (-not (Test-Path -LiteralPath $RepoRoot -PathType Container)) {
    ...
    Write-Host ('DRY_RUN COMPLETE {0} NO DASHBOARD PREP ACTIONS APPLIED.' -f [char]0x2014)
    exit 1
}
...
Test-RequiredFile -Label 'dashboard prep contract' -RelativePath 'docs\AI_OS\dashboard\AIOS_DASHBOARD_PREP_CONTRACT_DRAFT.md'
Test-RequiredFile -Label 'dashboard data input map' -RelativePath 'docs\AI_OS\dashboard\AIOS_DASHBOARD_DATA_INPUT_MAP_DRAFT.md'
Test-RequiredFile -Label 'dashboard prep validator' -RelativePath 'automation\status\Test-AiOsDashboardPrepContract.DRY_RUN.ps1'
Test-RequiredFile -Label 'Stage 36 health README' -RelativePath 'Reports\health\STAGE36A_36D_DASHBOARD_PREP_CONTRACT_README.txt'
...
Test-RequiredFile -Label 'Stage 33 analytics summary preview draft' -RelativePath 'docs\AI_OS\analytics\AIOS_DAILY_ANALYTICS_SUMMARY_PREVIEW_DRAFT.md'
Test-RequiredFile -Label 'Stage 34 analytics summary schema' -RelativePath 'docs\AI_OS\analytics\AIOS_DAILY_ANALYTICS_SUMMARY_SCHEMA_DRAFT.md'
Test-RequiredFile -Label 'Stage 35 analytics summary variants' -RelativePath 'docs\AI_OS\analytics\AIOS_DAILY_ANALYTICS_SUMMARY_VARIANTS_DRAFT.json'

$filesToScan = @(
    'docs\AI_OS\dashboard\AIOS_DASHBOARD_PREP_CONTRACT_DRAFT.md',
    'docs\AI_OS\dashboard\AIOS_DASHBOARD_DATA_INPUT_MAP_DRAFT.md',
    'Reports\health\STAGE36A_36D_DASHBOARD_PREP_CONTRACT_README.txt'
)
