...
Write-Host 'Task name: AI_OS Stage 38A-38D Static Dashboard Mock Contract Dry Run'
...
if (-not (Test-Path -LiteralPath $RepoRoot -PathType Container)) {
    ...
    Write-Host ('DRY_RUN COMPLETE {0} NO STATIC DASHBOARD MOCK ACTIONS APPLIED.' -f [char]0x2014)
    exit 1
}
