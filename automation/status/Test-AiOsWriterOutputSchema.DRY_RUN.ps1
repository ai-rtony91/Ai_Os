...
Write-Host 'Task name: AI_OS Stage 28A-28D Writer Output Schema Dry Run'
...
if (-not (Test-Path -LiteralPath $RepoRoot -PathType Container)) {
    ...
    Write-Host ('DRY_RUN COMPLETE {0} NO WRITER OUTPUT SCHEMA ACTIONS APPLIED.' -f [char]0x2014)
    exit 1
}
