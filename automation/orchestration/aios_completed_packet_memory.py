...
DEFAULT_COMPLETED_PACKETS = [
    ...
    },
    {
        ...
        "completion_reason": "local readiness contract, compact demo, month-end/dashboard propagation, docs, and tests validate broker-paper sandbox consideration boundaries without broker integration",
        "completed_files": [
