...
DEFAULT_COMPLETED_PACKETS = [
    ...
    },
    {
        ...
        "title": "Add paper-forward stress repair diagnostics",
        "lane": "paper-forward-stress-repair",
        "completion_reason": "stress repair diagnostics, conservative repair policy, compact demo, readiness/dashboard propagation, docs, and tests validated locally",
        "completed_files": [
