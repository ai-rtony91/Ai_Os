...
DEFAULT_COMPLETED_PACKETS = [
    ...
    },
    {
        ...
        "completion_reason": "local stress scenarios, deterministic out-of-sample splits, combined stress/OOS gate, demo, docs, and tests validate paper-only resilience evidence",
        "completed_files": [
