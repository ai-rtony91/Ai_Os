...
from automation.forex_engine.oanda_demo_sanitized_packet09_json_export_locator_v1 import (  # noqa: E402
    DEFAULT_JSON_PATH,
    PACKET_NAME,
    REPORT_PATH,
    run_sanitized_packet09_json_export_locator,
    write_sanitized_packet09_json_export_locator_report,
)
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    result = run_sanitized_packet09_json_export_locator(
        write_json=args.write_json,
        json_path=args.json_path,
    )
    report_path = None
    if args.write_report:
        report_path = write_sanitized_packet09_json_export_locator_report(
            result,
            args.report_path,
    ...
    payload = {
        "script_status": result["export_status"],
...
def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        allow_abbrev=False,
        description="AIOS OANDA demo sanitized Packet 09 JSON export locator V1.",
    )
