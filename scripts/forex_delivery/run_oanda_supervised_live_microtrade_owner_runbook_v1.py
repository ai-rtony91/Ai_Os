...
from automation.forex_engine.oanda_supervised_live_microtrade_owner_runbook_v1 import (  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Preview supervised live microtrade owner runbook."
    )
...
def main() -> int:
    args = parse_args()
    result = build_oanda_supervised_live_microtrade_owner_runbook(_select_sample(args))
    if args.json:
