"""Run the Forex 110 post-closure local residue cleanup plan."""
...
STATE_NAME = "AIOS_FOREX_110_POST_CLOSURE_LOCAL_RESIDUE_CLEANUP_PLAN_V1_STATE.json"
REPORT_NAME = "AIOS_FOREX_110_POST_CLOSURE_LOCAL_RESIDUE_CLEANUP_PLAN_V1_REPORT.md"
