...
from automation.forex_engine.forex_sos_owner_alert_bridge_v1 import (  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Preview AIOS Forex SOS owner alert bridge."
    )
...
def main() -> int:
    args = parse_args()
    result = evaluate_forex_sos_owner_alert_bridge(_select_sample(args))
    if args.json:
