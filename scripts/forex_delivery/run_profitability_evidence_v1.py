"""Run the local-only AIOS Forex profitability evidence engine V1."""
...
def main(argv: list[str] | None = None, stdout: TextIO | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Profitability Evidence V1 sample.")
    ...
    if args.blocked:
        thresholds["min_closed_trades"] = 100
