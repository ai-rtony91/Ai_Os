"""Run deterministic AIOS Forex walk-forward/OOS evidence intake."""
...
def main(argv: list[str] | None = None, stdout: TextIO | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run AIOS Forex walk-forward evidence intake.")
    parser.add_argument("--report-root", default="Reports/forex_delivery")
    parser.add_argument("--json", action="store_true")
    args = parser.parse_args(argv)

    result = intake_walk_forward_evidence(args.report_root)
