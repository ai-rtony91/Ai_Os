...
from automation.forex_engine.forex_statistical_profit_proof_gate_v1 import (  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Preview AIOS Forex statistical profit proof gate."
    )
...
def main() -> int:
    args = parse_args()
    result = evaluate_forex_statistical_profit_proof_gate(_select_sample(args))
    if args.json:
