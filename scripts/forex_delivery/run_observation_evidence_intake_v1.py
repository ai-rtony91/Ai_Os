"""Run deterministic AIOS Forex 22H/6D observation evidence intake."""
...
def main(argv: list[str] | None = None, stdout: TextIO | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run AIOS Forex observation evidence intake.")
    parser.add_argument("--report-root", default="Reports/forex_delivery")
    parser.add_argument("--json", action="store_true")
    args = parser.parse_args(argv)

    result = intake_observation_evidence(args.report_root)
