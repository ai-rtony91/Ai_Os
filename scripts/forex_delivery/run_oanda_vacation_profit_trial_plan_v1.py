...
from automation.forex_engine.oanda_vacation_profit_trial_plan_v1 import (  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Preview OANDA vacation profit trial plan."
    )
...
def main() -> int:
    args = parse_args()
    result = build_oanda_vacation_profit_trial_plan(_select_sample(args))
    if args.json:
