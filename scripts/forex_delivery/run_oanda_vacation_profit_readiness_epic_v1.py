...
from automation.forex_engine.oanda_vacation_profit_readiness_epic_v1 import (  # noqa: E402
    ...
    run_oanda_vacation_profit_readiness_epic,
    to_jsonable_dict,
    to_markdown,
    to_operator_text,
)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Preview OANDA vacation profit readiness proof gate epic."
    )
...
def main() -> int:
    args = parse_args()
    result = run_oanda_vacation_profit_readiness_epic(_select_sample(args))
    if args.json:
