...
from automation.forex_engine.oanda_supervised_live_microtrade_final_gate_v1 import (  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Preview supervised live microtrade final owner-run gate."
    )
...
def main() -> int:
    args = parse_args()
    result = evaluate_oanda_supervised_live_microtrade_final_gate(_select_sample(args))
    if args.json:
