"""CLI runner for Forex overnight repo-safe campaign planner V1."""
...
from automation.forex_engine.forex_overnight_repo_safe_campaign_planner_v1 import (
...
def main(argv: list[str] | None = None) -> int:
    ...
    result = run_forex_overnight_repo_safe_campaign_planner_v1()
    if args.write_state:
