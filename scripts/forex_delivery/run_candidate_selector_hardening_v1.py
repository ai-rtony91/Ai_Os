"""CLI runner for Forex candidate selector hardening V1."""
...
STATE_PATH = ROOT / "Reports" / "forex_delivery" / "AIOS_FOREX_CANDIDATE_SELECTOR_HARDENING_V1_STATE.json"
REPORT_PATH = ROOT / "Reports" / "forex_delivery" / "AIOS_FOREX_CANDIDATE_SELECTOR_HARDENING_V1_REPORT.md"
...
def main(argv: list[str] | None = None) -> int:
    ...
    result = run_candidate_selector_hardening_v1()
    if args.write_state:
