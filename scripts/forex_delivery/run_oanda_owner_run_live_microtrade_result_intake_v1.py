...
from automation.forex_engine.oanda_owner_run_live_microtrade_result_intake_v1 import (  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Preview owner-run live microtrade result intake."
    )
...
def main() -> int:
    args = parse_args()
    result = intake_oanda_owner_run_live_microtrade_result(_select_sample(args))
    if args.json:
