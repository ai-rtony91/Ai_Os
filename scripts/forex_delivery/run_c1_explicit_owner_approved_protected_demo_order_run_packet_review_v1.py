...
from automation.forex_engine.c1_explicit_owner_approved_protected_demo_order_run_packet_review_v1 import (  # noqa: E402
...
def generate_artifacts() -> dict[str, Any]:
    result = evaluate_p11_packet_review()
...
def main() -> None:
    ...
    print(f"p11_packet_review_status: {result['p11_packet_review_status']}")
    print(f"owner_run_packet_review_status: {result['owner_run_packet_review_status']}")
    print(f"post_p11_score: {result['post_p11_score']}")
