...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    payload = {
        ...
        "safe_owner_read_helper_status": result["safe_owner_read_helper_status"],
        "safe_owner_read_helper_name": result["safe_owner_read_helper_name"],
        "safe_owner_read_helper_bound": result["safe_owner_read_helper_bound"],
