...
from automation.forex_engine.c1_supervised_demo_trade_readiness_review_v1 import (  # noqa: E402
...
JSON_PATH = REPORT_DIR / "AIOS_FOREX_C1_SUPERVISED_DEMO_TRADE_READINESS_REVIEW_V1.json"
REPORT_PATH = (
    REPORT_DIR / "AIOS_FOREX_C1_SUPERVISED_DEMO_TRADE_READINESS_REVIEW_V1_REPORT.md"
)
QUEUE_PATH = (
    REPORT_DIR
    / "AIOS_FOREX_C1_SUPERVISED_DEMO_TRADE_READINESS_REVIEW_NEXT_ACTION_QUEUE_V1.md"
)
...
def main() -> int:
    ...
    print(f"p5_review_status: {result['p5_review_status']}")
    print(f"p6_readiness: {result['p6_readiness']}")
    print(f"post_p5_score: {result['post_p5_score']}")
