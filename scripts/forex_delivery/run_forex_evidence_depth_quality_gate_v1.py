...
from automation.forex_engine.forex_evidence_depth_quality_gate_v1 import (  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Preview AIOS Forex evidence-depth quality gate."
    )
...
def main() -> int:
    args = parse_args()
    result = evaluate_forex_evidence_depth_quality_gate(_select_sample(args))
    if args.json:
