...
from automation.forex_engine.oanda_supervised_live_microtrade_ticket_preview_v1 import (  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Preview sanitized supervised live microtrade ticket."
    )
...
def main() -> int:
    args = parse_args()
    result = build_oanda_supervised_live_microtrade_ticket_preview(_select_sample(args))
    if args.json:
