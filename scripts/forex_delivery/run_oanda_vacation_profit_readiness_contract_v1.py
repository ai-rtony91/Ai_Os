...
from automation.forex_engine.oanda_vacation_profit_readiness_contract_v1 import (  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Preview OANDA vacation profit readiness contract."
    )
...
def main() -> int:
    args = parse_args()
    result = evaluate_oanda_vacation_profit_readiness_contract(_select_sample(args))
    if args.json:
