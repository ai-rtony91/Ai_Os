...
Defines the read-only sanitized result contract for one Anthony-executed live microtrade result.

## Sample Results

- Profit sample: `OANDA_OWNER_RUN_LIVE_MICROTRADE_RESULT_CONTRACT_READY`
- Loss sample: `OANDA_OWNER_RUN_LIVE_MICROTRADE_RESULT_CONTRACT_READY`
- Breakeven sample: `OANDA_OWNER_RUN_LIVE_MICROTRADE_RESULT_CONTRACT_READY`
- Missing owner result sample: `OANDA_OWNER_RUN_LIVE_MICROTRADE_RESULT_CONTRACT_BLOCKED_UNSAFE`
- Unsafe sample: `OANDA_OWNER_RUN_LIVE_MICROTRADE_RESULT_CONTRACT_BLOCKED_UNSAFE`
