...
Checks whether the captured sanitized owner-run result is review-quality.

## Sample Results

- Profit sample: `OANDA_OWNER_RUN_LIVE_MICROTRADE_RESULT_QUALITY_READY_FOR_OWNER_REVIEW`
- Loss sample: `OANDA_OWNER_RUN_LIVE_MICROTRADE_RESULT_QUALITY_READY_FOR_OWNER_REVIEW`
- Breakeven sample: `OANDA_OWNER_RUN_LIVE_MICROTRADE_RESULT_QUALITY_READY_FOR_OWNER_REVIEW`
- Missing owner result sample: `OANDA_OWNER_RUN_LIVE_MICROTRADE_RESULT_QUALITY_REQUIRE_MORE_EVIDENCE`
- Unsafe sample: `OANDA_OWNER_RUN_LIVE_MICROTRADE_RESULT_QUALITY_BLOCKED_UNSAFE`
