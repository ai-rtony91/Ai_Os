...
This does **not** authorize runtime execution, runtime launch, queue write, scheduler registration, SOS send, broker action, live trading, secret storage, or vacation mode completion.
