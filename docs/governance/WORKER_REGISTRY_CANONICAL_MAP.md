...
The operator/window registry is compatibility evidence only. Keep it until adapter-first registry use is fully proven and Human Owner retirement approval is granted.
