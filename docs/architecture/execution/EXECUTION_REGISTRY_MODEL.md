\# AI\_OS Execution Registry Model
...
The execution registry defines which scripts are trusted, restricted, review-required, legacy, or blocked inside AI\_OS V2.
...
\- violates DRY\_RUN expectations
