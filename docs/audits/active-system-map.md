...
| Current path | Role | Connected systems | Dependency risk | Classification | Recommendation |
|---|---|---|---|---|---|
| `docs/AI_OS/context/AIOS_REPO_SOURCE_OF_TRUTH_MAP.md` | Header-hardened CLEAN-era source-of-truth map | Root/docs authority duplicate | high | MARK_REFERENCE_ONLY_COMPLETE / ARCHIVE_CANDIDATE_AFTER_DEPENDENCY_CONFIRMATION | Reference-only header applied. Archive after dependency confirmation, not merge-first, unless a specific durable rule is not already represented in active authority. |
| `docs/AI_OS/system_wizards/00_START_HERE_AI_OS_CONTEXT_PACK.md` | Header-hardened start-here brain | Operator/agent bootstrapping duplicate | high | MARK_REFERENCE_ONLY_COMPLETE / ARCHIVE_CANDIDATE_AFTER_DEPENDENCY_CONFIRMATION | Reference-only header applied. Archive after dependency confirmation, not merge-first, unless a specific durable rule is not already represented in active authority. |
| `docs/AI_OS/system_wizards/START_HERE_AI_OS_CONTEXT_PACK.md` | Header-hardened duplicate start-here brain | Operator/agent bootstrapping duplicate | high | MARK_REFERENCE_ONLY_COMPLETE / ARCHIVE_CANDIDATE_AFTER_DEPENDENCY_CONFIRMATION | Reference-only header applied. Archive after dependency confirmation, not merge-first, unless a specific durable rule is not already represented in active authority. |
| `docs/AI_OS/system_wizards/01_CURRENT_STATE.md` | Header-hardened current-state brain | Session context duplicate | medium | MARK_REFERENCE_ONLY_COMPLETE / ARCHIVE_CANDIDATE_AFTER_DEPENDENCY_CONFIRMATION | Reference-only header applied. Archive after dependency confirmation, not merge-first, unless a specific durable rule is not already represented in active authority. |
| `docs/AI_OS/system_wizards/02_CHECKPOINT.md` | Header-hardened checkpoint brain | Session context duplicate | medium | MARK_REFERENCE_ONLY_COMPLETE / ARCHIVE_CANDIDATE_AFTER_DEPENDENCY_CONFIRMATION | Reference-only header applied. Archive after dependency confirmation, not merge-first, unless a specific durable rule is not already represented in active authority. |
| `docs/AI_OS/operator/` | Header-hardened operator workflow duplicates | Workflows, launch rules, lane rules | high | MARK_REFERENCE_ONLY_COMPLETE / ARCHIVE_CANDIDATE_AFTER_DEPENDENCY_CONFIRMATION | Reference-only headers applied. Archive after dependency confirmation, not merge-first, unless a specific durable rule is not already represented in active authority. |
| `docs/AI_OS/operator_workflows/` | Header-hardened operator workflow duplicates | Morning/session/apply routing | high | MARK_REFERENCE_ONLY_COMPLETE / ARCHIVE_CANDIDATE_AFTER_DEPENDENCY_CONFIRMATION | Reference-only headers applied. Archive after dependency confirmation, not merge-first, unless a specific durable rule is not already represented in active authority. |
| `docs/AI_OS/codex/` | Header-hardened Codex instruction duplicates | Root `AGENTS.md` | high | MARK_REFERENCE_ONLY_COMPLETE / ARCHIVE_CANDIDATE_AFTER_DEPENDENCY_CONFIRMATION | Reference-only headers applied. Root `AGENTS.md` remains authority; archive after dependency confirmation. |
| `docs/AI_OS/claude/` | Header-hardened Claude delegation instructions | Optional reviewer workflow | medium | MARK_REFERENCE_ONLY_COMPLETE / NEEDS_HUMAN_DECISION | Reference-only header applied. Human decision required before retaining, retiring, promoting, or archiving Claude workflow material. |
| `docs/AI_OS/governance/` | Header-hardened governance duplicates | `docs/governance/` | high | MARK_REFERENCE_ONLY_COMPLETE / ARCHIVE_CANDIDATE_AFTER_DEPENDENCY_CONFIRMATION | Reference-only headers applied. Archive after dependency confirmation, not merge-first, unless a specific durable rule is not already represented in active authority. |
| `docs/AI_OS/index/` | Header-hardened index/ownership/source maps | Governance map duplicate | high | MARK_REFERENCE_ONLY_COMPLETE / ARCHIVE_CANDIDATE_AFTER_DEPENDENCY_CONFIRMATION | Reference-only headers applied. Archive after dependency confirmation, not merge-first, unless a specific durable rule is not already represented in active authority. |
