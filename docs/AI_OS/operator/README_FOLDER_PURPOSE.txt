...
Purpose: Operator workflow, preferences, command maps, escalation, and navigation planning.

Boundary: No automation execution, credential handling, broker actions, or protected-file edits.
