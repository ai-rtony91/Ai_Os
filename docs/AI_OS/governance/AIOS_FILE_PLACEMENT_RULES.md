...
This governance document defines placement rules for future Codex prompts, AI agents, scripts, and human work.
...
Active governance placement rules for AI_OS. These rules do not modify protected root files or approve implementation.
