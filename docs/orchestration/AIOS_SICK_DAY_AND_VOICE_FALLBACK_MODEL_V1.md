...
- **Sick-day and changed-voice handling** is mandatory and fail closed.
- **Fallback model** is mandatory and fail closed.
- **No security downgrade** is mandatory and fail closed.
- **Unavailable fallback fails closed** is mandatory and fail closed.
- **Recovery requires stronger and current authority** is mandatory and fail closed.
