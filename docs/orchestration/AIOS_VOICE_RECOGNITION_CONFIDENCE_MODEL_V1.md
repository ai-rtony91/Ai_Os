...
- **Deterministic confidence states** is mandatory and fail closed.
- **Ambiguity handling** is mandatory and fail closed.
- **Spoof/deepfake rejection** is mandatory and fail closed.
- **Unknown confidence fail closed** is mandatory and fail closed.
- **Threshold boundary tests** is mandatory and fail closed.
- **No voiceprint or biometric authority** is mandatory and fail closed.
- **No microphone or runtime activation** is mandatory and fail closed.
