...
- **Deterministic risk scoring** is mandatory and fail closed.
- **Threshold boundary tests** is mandatory and fail closed.
- **Unknown risk fails closed** is mandatory and fail closed.
- **Severity escalation** is mandatory and fail closed.
- **Missing evidence rejection** is mandatory and fail closed.
- **Stale or replayed approval rejection** is mandatory and fail closed.
- **Confused-deputy defense** is mandatory and fail closed.
