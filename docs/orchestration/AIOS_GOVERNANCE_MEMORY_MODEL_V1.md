...
- **Historical approvals never become current authority** is mandatory and fail closed.
- **Retention** is mandatory and fail closed.
- **Expiry** is mandatory and fail closed.
- **Revocation** is mandatory and fail closed.
- **Stale context rejection** is mandatory and fail closed.
- **Action binding** is mandatory and fail closed.
- **Deletion evidence** is mandatory and fail closed.
- **Archive poisoning defense** is mandatory and fail closed.
- **Unknown classification fail closed** is mandatory and fail closed.
